...
> 
> Ideally shouldnâ€™t use eval, because it inhibits many optimizations and makes code run slower.
...
> kitty.annoy();
> ```
> That doesnâ€™t work because inside the setInterval callback weâ€™ve created a new context with global scope, so this no longer points to our kitty instance. In a web browser, this will instead point to the Window object, which doesnâ€™t have a makeSound() method.
